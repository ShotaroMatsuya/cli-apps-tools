...
books_list =['The Hunger Games (The Hunger Games, #1) (Suzanne Collins)',
 ...
 'The Diary of a Young Girl (Anne Frank, Eleanor Roosevelt, B.M. Mooyaart-Doubleday)',
 'The Girl with the Dragon Tattoo (Millennium, #1) (Stieg Larsson, Reg Keeland)',
 'Catching Fire (The Hunger Games, #2) (Suzanne Collins)',
 'Harry Potter and the Prisoner of Azkaban (Harry Potter, #3) (J.K. Rowling, Mary GrandPré, Rufus Beck)',
 ...
 'Frankenstein (Mary Wollstonecraft Shelley, Percy Bysshe Shelley, Maurice Hindle)',
 ...
 'The Little Prince (Antoine de Saint-Exupéry, Richard Howard, Dom Marcos Barbosa, Melina Karakosta)',
 ...
 'Night (The Night Trilogy #1) (Elie Wiesel, Marion Wiesel)',
 ...
 'The Girl Who Played with Fire (Millennium, #2) (Stieg Larsson, Reg Keeland)',
 'Fifty Shades Darker (Fifty Shades, #2) (E.L. James)']


movies_list = ['Chinatown (1974)',
 'Touch of Evil (1958)',
 'Vertigo (1958)',
 ' Badlands (1973)',
 'Rashomon (1950)',
 ...
 'Andrei Rublev (1966.0)',
 'Mulholland Dr (2001.0)',
 'L’Atalante (1934.0)',
 'Tokyo Story (1953.0)',
 'Citizen Kane (1941.0)',
 'A Clockwork Orange (1971.0)',
 'Days of Heaven (1978.0)',
 'Wild Strawberries (1957.0)',
 'White Ribbon (2009.0)',
 'The Gospel According to St Matthew (1964.0)',
 'Aguirre Wrath of God (1972.0)',
 'Pather Panchali (1955.0)',
 'The Conformist (1970.0)',
 'Death in Venice (1971.0)',
 'The Godfather Parts I and II (1972.0)',
 'The Graduate (1967.0)',
 'There Will Be Blood (2007.0)',
 'Battleship Potemkin (1925.0)',
 'Rules of the Game (1939.0)',
 ' Shadows (nan)',
 'Distant Voices Still Lives (1988.0)',
 'Passion of Joan of Arc (1928.0)',
 'La Dolce Vita (1960.0)',
 'Breaking the Waves (1996.0)',
 'Spirit of the Beehive (1973.0)',
 '2001 (1968)',
 'Metropolis (1927)',
 'Blade Runner (1982)',
 'Alien (1979)',
...
programming_books = {"atariarchives.org":"(http://www.atariarchives.org) atariarchives.org makes books, information, and software for Atari and other classic computers available on the Web.",
...
"Microsoft Guides to Software":"(https://blogs.msdn.microsoft.com/mssmallbiz/2014/07/07/largest-collection-of-free-microsoft-ebo ks-ever-including-windows-8-1-windows-8-windows-7-office-2013-office-365-office-2010-sharepoint-2013-dynamics-crm-powershell-exchange-server-lync-2/)",
...
"Algorithms and Automatic Computing Machines (1963)":"(https://archive.org/details/Algorithms_And_Automatic_Computing_Machines) - B. A. Trakhtenbro",
...
"Programming on Parallel Machines; GPU, Multicore, Clusters and More":"(http://heather.cs.ucdavis.edu/parprocbook) - Norm Matloff Kerridge (PDF) (email address *requested*, not required)",
...
"A Tutorial on Pointers and Arrays in C":"(http://home.netcom.com/~tjensen/ptr/pointers.htm) - Ted Jensen http://pweb.netcom.com/~tjensen/ptr/cpoint.htm)",
"Bare-metal programming for ARM":"(https://github.com/umanovskis/baremetal-arm) - Daniels Umanovskis (http://umanovskis.se/files/arm-baremetal-ebook.pdf)",
...
"Elasticsearch: The Definitive Guide":"(https://www.elastic.co/guide/en/elasticsearch/guide/current/index.html) (https://github.com/elastic/elasticsearch-definitive-guide))",
...
"Joy of Elixir":"(https://joyofelixir.com) - Ryan Bigg (HTML) - (https://github.com/radar/joyofelixir) (:construction: *in process*)",
...
"Introduction to fortran 95 and numerical computing: a jump-start for scientists and engineers":"(http://people.cs.vt.edu/~asand /Deposit/Fortran95_notes.pdf) (PDF)",
...
"Gradle User Guide":"(https://docs.gradle.org/current/userguide/userguide.html) - Hans Dockter, Adam Murdoch ([https://docs.gradle.org/current/userguide/userguide.pdf))",
...
"The Grails Framework - Reference Documentation":"(http://grails.github.io/grails-doc/latest/) - Graeme Rocher, Peter Ledbrook, Marc Palmer, Jeff Brown, Luke Daley, Burt Beckwith, Lari Hotari ([http://grails.github.io/grails-doc/latest/guide/single.pdf))",
...
"Dive Into HTML5":"(http://diveinto.html5doctor.com) - Mark Pilgrim ([http://mislav.net/2011/10/dive-into-html5/))",
...
"Easy J by Linda Alvord, Norman Thomson":"(http://www.jsoftware.com/books/pdf/easyj.pdf) http://www.jsoftware.com/books/doc/easyj_doc.zip))",
...
"Spring Framework Reference Documentation":"(http://docs.spring.io/spring/docs/current/spring-framework-reference/html/) - Rod Johnson, Juergen Hoeller, Keith Donald, Colin Sampaleanu, Rob Harrop, Thomas Risberg, Alef Arendsen, Darren Davison, Dmitriy Kopylenko, Mark Pollack, Thierry Templier, Erwin Vervaet, Portia Tung, Ben Hale, Adrian Colyer, John Lewis, Costin Leau, Mark Fisher, Sam Brannen, Ramnivas Laddad, Arjen Poutsma, Chris Beams, Tareq Abedrabbo, Andy Clement, Dave Syer, Oliver Gierke, Rossen Stoyanchev, Phillip Webb, Rob Winch, Brian Clozel, Stephane Nicoll, Sebastien Deleuze ([https://docs.spring.io/spring/docs/current/spring-framework-reference/pdf/index.pdf))",
...
"The Road to learn React - Build a Hacker News App along the Way":"(https://leanpub.com/the-road-to-learn-react) - Robin Wieruch *(Leanpub account or valid email requested",
"markdown":"(https://github.com/the-road-to-learn-react/the-road-to-learn-react/tree/master/manuscript)",
...
"Programming With Objective-C":"(https://developer.apple.com/library/mac/documentation/Cocoa/Conceptual/ProgrammingWithObjective /Introduction/Introduction.html)",
...
"Laravel Collections Unraveled":"(https://leanpub.com/laravelcollectionsunraveled) - Jeffrey Madsen",
...
"A Whirlwind Tour of Python":"(http://www.oreilly.com/programming/free/files/a-whirlwind-tour-of-python.pdf) - Jake VanderPlas",
...
"The Little Book of Python Anti-Patterns":"(http://docs.quantifiedcode.com/python-anti-patterns/, (https://github.com quantifiedcode/python-anti-patterns))",
...
"Exploring Lift":"(http://exploring.liftweb.net) (published earlier as The Definitive Guide to Lif  http://groups.google.com/group/the-lift-book))",
...
"The Scheme Programming Language: Edition 3":"(http://www.scheme.com/tspl3/) (http://www.scheme.com/tspl4/)",
...
"Declare Peace on Virtual Machines. A guide to simplifying vm-based development on a Mac":"(https://leanpub.com/declarepeaceonvm /read)",
...
datascience_blogs = ["Data Science Central ",
"DataTau | Hacker News for Data Science ",
"KDnuggets | Data Science, Business Analytics, Big Data &amp; Data Mining ",
"Data Science | Reddit ",
"Data Science - Google News ",
"Analytics Vidhya ",
"DataCamp Blog ",
"Chris Albon - Data Science, Machine Learning, and Artificial Intelligence ",
"Yhat: The Yhat (Pronounced Y-hat) Blog ",
"Data Science 101 ",
"Data Plus Science ",
...
"Data Science at NIH ",
"MailChimp Data science – MailChimp Email Marketing Blog ",
"IBM Data Science Experience Blog ",
"NYU Center for Data Science ",
"UC San Diego's Data Science Blog – Center for Computational Biology &amp; Bioinformatics ",
"University of Wisconsin - Data Science Blog ",
"Kaggle | Data Science News – No Free Hunch ",
"Codementor | Data Science Tutorials ",
"DataScience@SMU - Southern Methodist University ",
"Dataquest Blog ",
"Data Science made in Switzerland ",
"Master's in Data Science ",
"Manipal Global Academy of Data Science ",
"DATAVERSITY » Data Science News, Articles, &amp; Education ",
"District Data Labs ",
...
"Dimensionless Technologies Blog | Data Science &amp; Business Analytics ",
"Data Science, Database, Tools and QA Learning's ",
"Mad (Data) Scientist ",
...
"DSI Analytics - Data Science Insights ",
"The Data Blogger ",
"Data Science Africa ",
"Datapolitan ",
"ilia's Data Science blog ",
"SFL Scientific - Data Science Consultants ",
"Datalore Labs Blog ",
"Nina B. Zumel | Data Science ",
"ikigomu ",
"Backyard Data Science | Precision Guesswork While You Wait ",
"My Data Science and Big Data blog ",
"Socrates Data Science Blog ",
"Analytics Insight ",
"ERDataDoc ",
"Carlo Carandang - Data Science  ",
"Data Science Consulting LLC ",
"FOXY DATA SCIENCE ",
"Data Science Unicorn ",
"Data Science Diary ",]

datascience_links = [{"Data Science Central":"http://www.datasciencecentral.com",
 "Analytics Vidhya":"https://www.analyticsvidhya.com",
 "DataCamp Blog":"https://www.datacamp.com",
 "Data Plus Science":"https://www.dataplusscience.com",
 "Codementor | Data Science Tutorials":"https://www.codementor.io",
 "Dataquest Blog":"https://www.dataquest.io",
 "Master\'s in Data Science":"http://www.mastersindatascience.org",
 "data science ish":"http://www.dataversity.net",
 "The Data Incubator":"https://www.datarobot.com",
 "Little Miss Data":"https://www.littlemissdata.com",
 "data science ish":"https://www.datascience.com",
 "data science ish":"http://www.datascienceassn.org",
 "The Unofficial Google Data Science Blog":"http://www.unofficialgoogledatascience.com",
 "Jean-Nicholas Hould - On Data Science":"http://www.jeannicholashould.com",
 "b.telligent - Data Science Blog":"http://www.btelligent.com",
 "InnoArchiTech ":"https://www.innoarchitech.com",
 "Becoming A Data Scientist":"http://www.becomingadatascientist.com",
 "Neural Market Trends":"http://www.neuralmarkettrends.com",
 "Perfect Price Blog":"http://www.perfectprice.io",
 "Analytics Insight":"http://www.analyticsinsight.net",
 "data science ish":"http://www.foxydatascience.com",
...
christianbooks_list = [" Confessions (by Saint Augustine)",
...
" Complete English Poems (by George Herbert)",
...
" The Cloud of Unknowing and Other Works (by Anon)",

" Christ and Culture (by H. Richard Niebuhr)",

" Mere Christianity (by C. S. Lewis)",

" Ecclesiastical History of the English People With Bede's Letter to Egbert and Cut... (by the Venerable Saint Bede)",
...
" Interior Castle The Classic Text with a Spiritual Commentary (by St. Teresa of Avila)",

" The Philokalia The Complete Text Compiled (by St.Nikodimos of the Holy Mountain an... (by Anon)",
...
" Collected Poems: - R.S.Thomas Collected Poems : R S Thomas (by R. S. Thomas)",

" Moral Man and Immoral Society A Study in Ethics and Politics (by Reinhold Niebuhr)",

" A Theology of Liberation (by Gustavo Gutierrez)",

" In Memory of Her Feminist Theological Reconstruction of Christian Origins (by Elisabeth Schussler Fiorenza)",
...
" The Prayers and Meditations of St. Anselm with the Proslogion (by Saint Anselm, Archbishop of Canterbury)",

" Philip Yancey Recommends: Orthodoxy (by G. K. Chesterton)",

" The Practice of the Presence of God (by Brother Lawrence)",

" The Cost of Discipleship, New Edition  New Edition (by Dietrich Bonhoeffer)",

" The Quest of the Historical Jesus (by Albert Schweitzer)",

" The Idea of the Holy (by Rudolf Otto)",

" The Christian Priest Today (by Arthur Michael Ramsey)",
...
" Love's Endeavour, Love's Expense The Response of Being to the Love of God (by W.H. Vanstone)",

" Christianity Rediscovered (by Vincent J. Donovan)",

" The Wound of Knowledge Christian Spirituality from the New Testament to St. John ... (by Rowan Williams)",

" The Epistle to the Romans (by Karl Barth)",

" The Crucified God th Anniversary Edition (by Jurgen Moltmann)",
...
" Mystical Theology and the Celestial Hierarchies (by Dionysus the Aeropagite)",

" The Rule and Exercises of Holy Dying (by Jeremy Taylor)",

" Grace Abounding With Other Spiritual Autobiographies (by John Bunyan)",

" On God and Christ The Five Theological Orations and Two Letters to Cledonius (by Gregory of Nazianzus)",

" The Complete Introduction to the Devout Life (by St. Francis De Sales)",
...
" Old Testament Theology The Theology of Israel's Historical Traditions (by Gerhard Von Rad)",

" Purity of Heart is to Will One Thing Spiritual Preparation for the Office of Conf... (by Soren Kierkegaard)",

" The Foolishness of God (by John Austin Baker)",

" Gilead (by Marilynne Robinson)",

" The Descent of the Dove A Short History of the Holy Spirit in the Church (by Charles Williams)",

" The True Wilderness (by Williams, H.A.)",

" The Man Born to Be King (by Dorothy Sayers)",

" The Go-between God (by John V Taylor)",

" The Stature of Waiting (by W. H. Vanstone)",
...
" Principles of Christian Theology Revised Edition (by John Macquarrie)",
" Surprised (by Joy )",

"Third Edition (by Paul Tillich)",

" Basic Christianity Who is Jesus? Why the Cross? Why is it Relevant Today? (by John R. W. Stott)",

" Evil and the God of Love (by John Harwood Hick)",

" Foxe's Book of Martyrs Select Narratives (by John Foxe)",

" The Stripping of the Altars Traditional Religion in England,- (by Eamon Duffy)",
...
" Love Almighty and Ills Unlimited (by Austin Farrer)",

" The Vision of God Christian Doctrine of the Summum Bonum (by Kenneth E. Kirk)",
